...
#define CONFIG_EXAMPLES_DIR "CTC/i3 with Anet 1 (Atmega 1284P)/"
...
#define STRING_CONFIG_H_AUTHOR "(Tuuli Pollanen)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tower of Power"
